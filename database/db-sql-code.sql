...
ALTER TYPE public.account_type OWNER TO starterdb_hw5;
--Create Support Status ENUM
CREATE TYPE public.support_status AS ENUM ('Open', 'In Progress', 'Closed');
ALTER TYPE public.support_status OWNER TO starterdb_hw5;
...
CREATE TABLE IF NOT EXISTS public.support_tickets (
    ...
    ticket_subject character varying NOT NULL,
    ticket_description character varying NOT NULL,
    ticket_status character varying NOT NULL DEFAULT 'Open',
    ticket_created_at timestamp without time zone NOT NULL DEFAULT now(),
    account_id integer NOT NULL,
    CONSTRAINT support_tickets_pkey PRIMARY KEY (ticket_id),
    CONSTRAINT support_tickets_account_fkey FOREIGN KEY (account_id) REFERENCES public.account (account_id) ON DELETE CASCADE
);
